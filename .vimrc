...
set fileformats=unix,mac,dos " 改行コードの自動判別. (左側が優先)
...
" Search
"----------------------------------------------------------
set incsearch " インクリメンタルサーチ. １文字入力毎に検索を実行
set ignorecase " 検索パターンの大文字小文字を区別を無視
set smartcase " 検索パターンに大文字を含んでいたら大文字小文字を区別
set hlsearch " 検索結果をハイライト
set showmatch " 括弧の対応関係を一瞬だけ表示

"----------------------------------------------------------
" Command mode
"----------------------------------------------------------
set wildmenu " コマンドモードの補完
set history=3000 " 保存するコマンドの履歴数

"----------------------------------------------------------
" Enable mouse cursor movement and scrolling
"----------------------------------------------------------
if has('mouse')
    set mouse=a
    if has('mouse_sgr')
...
"----------------------------------------------------------
" Indents are prohibited when pasting from the clipboard
"----------------------------------------------------------
if &term =~ "xterm"
    let &t_SI .= "\e[?2004h"
    let &t_EI .= "\e[?2004l"
